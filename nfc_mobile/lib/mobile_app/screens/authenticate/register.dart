                ...
                scrollDirection: Axis.vertical,
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      height: 50, width: MediaQuery.of(context).size.width * .8,
                      child: StreamBuilder(
                        stream: Firestore.instance.collection('companies').getDocuments().asStream(),
                                  ...
                                  child: Container(
                                    ...
                                    child: DropdownButtonHideUnderline(
                                      child: DropdownButton<String>(       
                                        value: _company,
                                        onChanged: (String selCompany) {
                                          companies.forEach((element) {
                                            if(selCompany == element.toString()) {
                                              setState(() => _company = selCompany);
                                            }
                                          });
                                        },
                                        hint: Padding(
